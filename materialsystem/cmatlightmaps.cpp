...
fltx4 ConvertLightmapColorToRGBScale( FLTX4 lightmapColor )
{
	...
	static const fltx4 FourPoint1s = FLTX4_SET_PS(0.1, 0.1, 0.1, 0.1);
	static const fltx4 vTwoFiftyFiveOverSixteen = FLTX4_SET_PS(255.0f / 16.0f, 255.0f / 16.0f, 255.0f / 16.0f, 255.0f / 16.0f);
	// static const fltx4 vSixteenOverTwoFiftyFive = FLTX4_SET_PS(16.0f / 255.0f, 16.0f / 255.0f, 16.0f / 255.0f, 16.0f / 255.0f);
...
#define	FOUR (sizeof( Vector4D ) / sizeof( float ))  //  make explicit when we're incrementing by length of a 4dvec
		...
		{				
			static const fltx4 vSixteen = FLTX4_SET_PS(16.0f, 16.0f, 16.0f, 16.0f);
