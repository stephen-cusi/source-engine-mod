...
void MapLinearIntensities(FourVectors const &intens,uint32 *p1, uint32 *p2, uint32 *p3, uint32 *p4)
{
	...
	static fltx4 pixscale = FLTX4_SET_PS(255.0,255.0,255.0,255.0);
	fltx4 r,g,b;
...
static fltx4 all_zeros = FLTX4_SET_PS(0,0,0,0);
static fltx4 TraceLimit = FLTX4_SET_PS(1.0e20,1.0e20,1.0e20,1.0e20);
